...
public class CalDatasetLoadingTest {
	...
	public static void main(String[] args) {
		...
		ArrayList<Node> myVertices = UtilsManagment.readNodeFile(nodeDatasetFile);
		System.out.println("Vertex File Imported Successfully!" + myVertices);

		ArrayList<Edge> myEdges = UtilsManagment.readEdgeFile("Datasets/CAL-Edge_Eid-ESrc-EDest-EDist.csv");
		System.out.println("Edge File Imported Successfully!");
		System.out.println(myEdges.get(0).getEdgeId());

		UtilsManagment.readRoadObjFile("CAL-POI_POIName-POILong-POILat.csv");
