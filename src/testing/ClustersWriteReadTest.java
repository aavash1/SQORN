...
public class ClustersWriteReadTest {
...
//		ClusteringRoadObjects clusterRObjects = new ClusteringRoadObjects();		
		...
		Map<Integer, LinkedList<Integer>> nodeClusterFromFile = UtilsManagment.readNodeClustersFile("ClusterDatasets/California_node_2019-12-06 16-15-20.csv");
		
		for (Integer index : nodeClusterFromFile.keySet()) { 
			System.out.println(index + ": " + nodeClusterFromFile.get(index));
		}
