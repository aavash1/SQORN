...
public class ANNEvaluationOldenRealDatasetTest {
	...
	public static void main(String[] args) {
		...
		String objectDatasetFile = "GeneratedFiles/Oldenburg_30000_T_F_20000_10000_2019-12-05 00-37-11.csv";
		...
		for (int i = 1; i < 10; i++) {
			...
			Map<Integer, LinkedList<Integer>> nodeIdClusters = clusteringNodes.cluster(oldenGraph);
			...
			annClustered.computeWithoutClustering(oldenGraph, true, nodeIdClusters, objectIdClusters);
