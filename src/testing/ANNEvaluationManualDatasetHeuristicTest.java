...
public class ANNEvaluationManualDatasetHeuristicTest {
	...
	annClustered.computeWithTime(gr, true);
		...
		// um.writeNaiveAndClusteredANNTestResult(gr, totalNumberOfNodeClusters,
		// totalNumberOfObjectClusters, graphLoadingTimeDNaive,
