			...
			for (Integer objectClusterIndex : m_objectIdClusters.keySet()) {
				...
				if (!m_objectIdClusters.get(objectClusterIndex).isEmpty()) {
					...
					if (m_objectIdClusters.get(objectClusterIndex).size() == 1) {
						...
						// ArrayList<RoadObject>
						// objectList=m_graph.returnAllObjectsOnNodeCluster(m_nodeIdClusters.get(currentClusterIndex));
						// for(int i=0;i<objectList.size();i++) {
						// System.out.println((i+1)+ " road object is
						// "+objectList.get(i).getObjectId()+" and is "+objectList.get(i).getType()+ "
						// object.");
						// }
						...
						if (gr.isTerminalNode(endNode1)) {
							...
							for (int i = 0; i < objectList.size(); i++) {
								System.out.println((i + 1) + " object is: " + objectList.get(i).getObjectId()
										+ " and the type is: " + objectList.get(i).getType());
							}
							System.out.println("");
							...
							//System.out.println("--here is the key--1");
