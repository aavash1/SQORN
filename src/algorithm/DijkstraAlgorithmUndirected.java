...
public class DijkstraAlgorithmUndirected extends RoutingAlgorithm {
	...
	public DijkstraAlgorithmUndirected(Graph graph) {
	...
	private int getDistance(Node node, Node target) {
	        for (Edge edge : edges) {
	        	...
	        	else if (edge.getEndNodeId() == node.getNodeId()
	                    && edge.getStartNodeId() == target.getNodeId()) {
	                return UtilsManagment.convertDoubleToInteger(edge.getLength());
	            }
...
//	            }
	...
	private List<Node> getNeighbors(Node node) {
	        ...
	        for (Edge edge : edges) {
	            ...
	            else if(edge.getEndNodeId()==node.getNodeId() && !isSettled(edge.getStartNodeId())){
	            	neighbors.add(getNode(edge.getStartNodeId()));
	            }
//	            if (edge.getSource().equals(node)
